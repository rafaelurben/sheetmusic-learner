...
- Player
    - [FR-08 — Page navigation](#fr-08--page-navigation)
    - [FR-09 — Playback with tempo multiplier](#fr-09--playback-with-tempo-multiplier)
    - [FR-10 — Visual cursor](#fr-10--visual-cursor)
...
- Rooms
    - [FR-11 — Create room](#fr-11--create-room)
    - [FR-12 — Share piece to room](#fr-12--share-piece-to-room)
    - [FR-13 — List, join and leave rooms](#fr-13--list-join-and-leave-rooms)
    - [FR-14 — Room chat](#fr-14--room-chat)
    - [FR-15 — Owner control & sync](#fr-15--owner-control--sync)
    - [OFR-01 — Change room visibility](#ofr-01--change-room-visibility)
- General
    - [FR-16 — OAuth sign-in](#fr-16--oauth-sign-in)
...
#### FR-13 — List, join and leave rooms
